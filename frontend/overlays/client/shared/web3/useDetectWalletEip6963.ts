...
// Rebrand overlay: WALLET_RDNS_MAP requires an entry per WalletType. The VoltusWave
// Wallet does not implement EIP-6963 (it injects window.ethereum.isVoltusWave), so
// this rdns is a placeholder to satisfy the type — it won't match any announced
// provider, and detection falls through to detect-wallet's isVoltusWave check.
...
const WALLET_RDNS_MAP: Record<WalletType, string> = {
  voltuswave: 'com.voltuswave.wallet',
